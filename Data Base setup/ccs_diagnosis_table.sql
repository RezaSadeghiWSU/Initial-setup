...
\copy ccs_single_level_dx from 'ccs_single_level.csv' DELIMITER ',' CSV HEADER NULL ''
...
\copy ccs_multi_level_dx from 'ccs_multi_level.csv' DELIMITER ',' CSV HEADER NULL ''
